...
- **대사 자동 진화** — 주 1회 Claude가 새 대사를 지어줘서 펫의 수다가 계속 신선합니다 (Claude Code CLI 사용)
...
- **Self-evolving chatter** — once a week, Claude writes fresh lines for your pet (via the Claude Code CLI)
